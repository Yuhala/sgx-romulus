...
static const int REGISTRY_MAX_THREADS = 4; //romulus uses 128 by default
 ...
 * This tid will be saved in a thread-local variable of the type ThreadCheckInCheckOut which
